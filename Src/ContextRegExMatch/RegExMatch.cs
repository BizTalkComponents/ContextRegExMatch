...
namespace BizTalkComponents.PipelineComponents.ContextRegExMatch
{
    ...
    public partial class RegExMatch: IBaseComponent, Microsoft.BizTalk.Component.Interop.IComponent, IComponentUI, IPersistPropertyBag
    {
        ...
        [Description("The value to set if the match is successful")]
        ...
        public IBaseMessage Execute(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            // This will force promotion of in the pipeline previously set property promotions. 
            // This is needed as promotion will occur in a streaming fashion and we otherwise won't have the previously promoted property within 
            // our current context.
